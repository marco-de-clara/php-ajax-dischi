...
$(document).ready(function () {
    ...
    for (var i = 0; i < $('.record').length; i++) {
      if (chosen_genre != '') {
        ...
        if (chosen_genre != 'all') {
          ...
          var record_genre = $('.genre').eq(i).text().trim().toLowerCase(); // if current record genre equals chosen genre
  ...
  $('#artist').change(function () {
    // get chosen artist
    var chosen_artist = $('#artist :selected').val(); // loop for the number of artists (except "" and "all") to show a specific artist
    ...
    for (var i = 0; i < $('#artist option').length - 2; i++) {
      if (chosen_artist != '') {
        ...
        if (chosen_artist != 'all') {
          ...
          var record_artist = $('.author').eq(i).text().trim().toLowerCase(); // if current record artist equals chosen artist
...
__webpack_require__(/*! E:\MAMP\htdocs\php-ajax-dischi\versione-php\src\js\app.js */"./src/js/app.js");
module.exports = __webpack_require__(/*! E:\MAMP\htdocs\php-ajax-dischi\versione-php\src\scss\app.scss */"./src/scss/app.scss");
